<template>
  <div class="app-container">
    <el-form ref="" :model="form" label-width="100px" style="width: 95%; margin-top: 10px;" size="small">
      ...
      <el-form-item label="文章内容">
        <div class="section-editor">
          <quillEditor v-model="form.content" ref="vueQuillEditor" :options="editorOption"
    ...
    created() {
      ...
      if (this.isEdit) {
        getArticleById(this.$route.query.id).then(resp => {
          ...
          this.form = resp.data
          // Object.keys(this.form).forEach(key=>{obj2[key]=this.form[key]})
        ...
        this.form = Object.assign({}, defaultArticle)
      }

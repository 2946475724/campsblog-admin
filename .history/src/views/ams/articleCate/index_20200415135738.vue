<template>
  <div class="app-container">
    <el-card class="filter-container" shadow="never">
      <div>
        <el-input style="width: 203px; margin-right: 20px;" size="small" placeholder="分类名"></el-input>
        <el-button size="small" icon="el-icon-search" type="primary" @click="handleSearchList()">
          查询
        </el-button>
        <el-button size="small" class="btn-add" icon="el-icon-edit" type="primary" @click="handleAdd()">
          添加
        </el-button>
      </div>
    </el-card>

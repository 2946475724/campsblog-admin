    ...
    <el-row :gutter="32">
      <el-col :xs="24" :sm="24" :lg="8">
        <div class="chart-wrapper">
          <pie-chart ref="articleSortPie" @clickPie="clickArticleSortPie" v-if="showPieArticleSortChart"
            :value="articleCountByCategory" :tagName="articleSortNameArray"></pie-chart>
        </div>
      </el-col>
    </el-row>

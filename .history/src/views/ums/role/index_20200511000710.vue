          ...
          if (resp.code === 200) {
            ...
            fetchTreeList().then(resp => {
              if (resp.code === 200) {
                ...
                for (let i = 0; i <= treeMenuList1.length; i++) { console.log(treeMenuList1[i].children) for (let j=0; j
                  <=treeMenuList1[i].children.length; j++) { for (let k=0; k <=menuList1.length; k++) { if
                  (menuList1[i].children[j].id===menuList1[k].id) { expandedKeys.push(menuList1[k].id) } } } }
              }
            });
          }

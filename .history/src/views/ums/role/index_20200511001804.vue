            ...
            fetchTreeList().then(resp => {
              if (resp.code === 200) {
                ...
                for (let i =0; i < menuList1.length; i++) {
                  for(let j =0; j < treeMenuList1.length; j++) {
                    for (let k = 0; k < treeMenuList1[j].children.length; k++) {
                      if (menuList1[i].id === treeMenuList1[j].children[k]) {
                        this.expandedKeys.push(menuList1[k].id)
                      }
                    }
                  }
                }
                // for (let i = 0; i <= treeMenuList1.length; i++) {
                //   for (let j = 0; j <= treeMenuList1[i].children.length; j++) {
                //     for (let k = 0; k <= menuList1.length; k++) {
                //       if (menuList1[i].children[j].id === menuList1[k].id) {
                //         this.expandedKeys.push(menuList1[k].id)
                //       }
                //     }
                //   }

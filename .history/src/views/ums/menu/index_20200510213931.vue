    ...
    <div class="table-container">
      <el-table :data="list" style="width: 100%;" v-loading="listLoading">
                ...
                <el-table-column align="center">
                  <template slot-scope="scope_child">
                    <el-switch v-model="scope_child.row.hidden" active-color="#409eff" inactive-color="#C0CCDA"
                      ...
                      @change="handleChange(scope_child.row.id, scope_child.row.hidden)">
                    </el-switch>
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            <el-switch v-model="scope.row.hidden" active-color="#409eff" inactive-color="#C0CCDA" :active-value="0"
              :inactive-value="1" @change="handleChange(scope.row.id, scope.row.hidden)">
            </el-switch>
            <!-- <el-button size="mini" type="text" @click="handleUpdate(scope.$index, scope.row)">编辑
            </el-button>
            <el-button size="mini" type="text" @click="handleDelete(scope.$index, scope.row)">删除

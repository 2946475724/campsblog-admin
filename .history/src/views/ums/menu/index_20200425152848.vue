          ...
          <el-form label-position="left" inline class="demo-table-expand">
            <el-table :data="scope.row.children" show-header="false" style="width: 100%">
              ...
              <el-table-column label="菜单名称" align="center">
                <template slot-scope="scope">{{props.row.title}}</template>
              </el-table-column>
              <el-table-column label="菜单级数" align="center">
                <template slot-scope="scope">{{props.row.level === 0 ? '一级' : '二级'}}</template>
              </el-table-column>
              <el-table-column label="前端名称" align="center">
                <template slot-scope="scope">
                  <el-tag type="">{{props.row.name}}</el-tag>
                </template>
              </el-table-column>
              ...
              <el-table-column label="是否显示" width="160" align="center">
                <template slot-scope="scope">{{props.row.hidden === 0 ? "显示" : "隐藏"}}</template>
              </el-table-column>
              <el-table-column label="排序" width="140" align="center">
                <template slot-scope="scope">{{props.row.sort}}</template>
              </el-table-column>
              <el-table-column label="操作" width="180" align="center">
                <template slot-scope="scope">
                  <el-button size="mini" type="text" @click="handleSelectRole(props.$index, props.row)">分配角色
                  </el-button>
                  <el-button size="mini" type="text" @click="handleUpdate(props.$index, props.row)">编辑
                  </el-button>
                  <el-button size="mini" type="text" @click="handleDelete(props.$index, props.row)">删除
                  </el-button>
                </template>
              </el-table-column>
            </el-table>

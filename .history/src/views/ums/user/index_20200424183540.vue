<template> 
  <div class="app-container">
    ...
    <el-dialog title="分配角色" :visible.sync="allocDialogVisible" width="30%">
      <el-select v-model="allocRoleName" placeholder="请选择" size="small" style="width: 80%">
    ...
    methods: {
      ...
      handleAllocDialogConfirm() {
        this.$confirm('是否要确认?', '提示', {
          ...
          params.append("adminId", this.allocUserId);
      ...
      handleSelectRole(index, row) {
        ...
        console.log(this.list.roleName)
        this.allocRoleName = this.list.roleName

<template>
  <div class="app-container">
    <el-card class="filter-container" shadow="never">
      <div>
        <el-input style="width: 203px; margin-right: 20px;" size="small" type="text" placeholder="文章标题" v-model="keyword"></el-input>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // },
      search() {
        // this.defaultQuery.keyword = this.keyword
        console.log(this.defaultQuery.keyword)
      },
    },
  };
